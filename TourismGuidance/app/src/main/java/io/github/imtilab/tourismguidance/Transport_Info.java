...
public class Transport_Info extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_transport__info);
        getSupportActionBar().hide();

        tabLayout= (SlidingTabLayout) findViewById(R.id.tabs);
        pager = (ViewPager) findViewById(R.id.pager);

        tabLayout.setCustomTabView(R.layout.transport_tab_view, R.id.transport_tab_title);
        MyAdapter2 adapter =  new MyAdapter2(getSupportFragmentManager());
